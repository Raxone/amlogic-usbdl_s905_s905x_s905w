...
#define _clear_icache() ((void (*)(void))0xd904077c)()
#define _dwc_pcd_irq() ((void (*)(void))0xd9042528)()
#define _start_bulk_transfer(pcd) ((void (*)(volatile pcd_struct_t *))0xd9048618)(pcd)
#define BOOTROM_ADDR 0xD9000000
...
{
    volatile pcd_struct_t *pcd = (pcd_struct_t *)0xd900f8f8;
...
void _start()
{
    ...
    usb_setup_bulk_in((unsigned char *)BOOTROM_ADDR, 0x14000);
    do
    {
        watchdog_reset();
        _dwc_pcd_irq();
